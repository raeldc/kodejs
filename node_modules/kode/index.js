...
Kode.prototype.getObject = function(identifier, config)
{
    ...
    if (object !== undefined) {
        var objectConfig = (identifier === 'lib:object.config') ? config : this.getObject('lib:object.config', config);
...
Kode.prototype.defineObject = function(identifier, parent, definition)
{
    ...
    if (typeof identifier !== 'string' || identifier.length === 0) throw new TypeError('Invalid Identifier');

    if (this.objectRegistry[identifier] !== undefined) throw new Error('Cannot Redefine Object');
    ...
    var object = {
        CLASS: function() 
        {
            if(typeof this.construct === 'function'){
                ...
                this.construct.apply(this, [config]);

                // Delete these methods so they can't be called anymore
    ...
    if (typeof parent === 'string') {
        if (parent.length === 0) throw new TypeError('Parent identifier should be a valid string');
